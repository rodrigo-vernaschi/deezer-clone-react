...
const Mixes = () => {
    const { coverArtURL, trackName, artistName } = MusicAPI();

    console.log(coverArtURL, trackName, artistName);
                ...
                <table id={styles.mixes_table}>
                    <tbody>
                        <tr>
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix1"></div>
                                    <div
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix2"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix3"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix4"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                        ...
                        <tr>
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix5"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix6"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix7"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix8"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                        ...
                        <tr>
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix9"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix10"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix11"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
                            ...
                            <td>
                                <div className={styles.mix_panel_container}>
                                    <div className={styles.mix_img_container} id="mix12"></div>
                                    <div
                                        id={styles.mix_icon_play_container}
                                        onMouseEnter={() => {
